...
const useStyles = makeStyles({
  crod: { background: '#EDF0F7', borderRadius: '15px', padding: '0px 5px', margin: '0px 10px' },
  crodTitel: { height: "5px", direction: 'rtl' },
  hr: { color: '##0B204C', opacity: '0.1', height: '1px' },
  cradflex: { width: '200px' },
  ul: { margin: '0', padding: '0', direction: 'rtl', height: "80px", overflow: 'auto' },
